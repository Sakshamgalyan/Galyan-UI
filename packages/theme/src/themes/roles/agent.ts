...
/**
 * Agent role override for EasyLife brand.
 * Changes primary to coral, secondary to warm orange.
 * Also shifts neutrals from cool slate to warm stone.
 */
export const agentOverrideEasylife: RoleOverride = {
  primary: {
    50: "#fef2f2",
    100: "#fee2e2",
    200: "#fecaca",

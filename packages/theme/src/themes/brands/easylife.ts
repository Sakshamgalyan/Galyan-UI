/** EasyLife brand theme — green primary, slate neutrals, light canvas */
export const easylifeBrand = {
  // ── Primary (Green — default for customer role) ───────────────────────
  primary: {
    50: "#f0fdf4",
    100: "#dcfce7",
    200: "#bbf7d0",
...
export type BrandTheme = DeepString<typeof easylifeBrand>;

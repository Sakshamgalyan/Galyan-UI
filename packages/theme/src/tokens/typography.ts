...
export const headingScale = {
  h1: { size: '5xl', weight: 'bold', lineHeight: 'tight', letterSpacing: 'tight' },
  h2: { size: '4xl', weight: 'bold', lineHeight: 'tight', letterSpacing: 'tight' },
  h3: { size: '3xl', weight: 'semibold', lineHeight: 'snug', letterSpacing: 'normal' },
  h4: { size: '2xl', weight: 'semibold', lineHeight: 'snug', letterSpacing: 'normal' },
  h5: { size: 'xl', weight: 'semibold', lineHeight: 'normal', letterSpacing: 'normal' },
  h6: { size: 'lg', weight: 'semibold', lineHeight: 'normal', letterSpacing: 'normal' },
} as const;
...
export const captionScale = {
  'caption-lg': { size: 'xs', weight: 'medium', lineHeight: 'normal', letterSpacing: 'wide' },
  'caption-md': { size: '2xs', weight: 'medium', lineHeight: 'normal', letterSpacing: 'wide' },
} as const;

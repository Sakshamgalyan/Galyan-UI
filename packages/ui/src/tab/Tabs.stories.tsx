...
const demoItems = [
  {
    ...
    label: "Overview",
    content: (
      <p>Overview content goes here. This is the main dashboard view.</p>
    ),
  },
  {
    id: "analytics",
    label: "Analytics",
    badge: 3,
    content: <p>Analytics data and charts would render in this panel.</p>,
  },
  {
    id: "reports",
    label: "Reports",
    content: <p>Report generation tools and export options live here.</p>,
  },
  {
    id: "settings",
    label: "Settings",

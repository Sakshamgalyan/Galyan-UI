        ...
        {skeletonContent ? (
          ...
          >
            ...
            {Array.from({ length: skeletonLines }).map((_, idx) => (
              <Skeleton
                key={idx}
                width={idx === skeletonLines - 1 ? "70%" : "100%"}
                height="0.875rem"
              />
            ))}
          </div>
...
export function CardHeader({
  ...
  return (
    <div className={`gy-card-header ${className}`} style={style} {...props}>
      {children}
    </div>
  );
}
...
export function CardBody({
  ...
  return (
    <div className={`gy-card-body ${className}`} style={style} {...props}>
      {children}
    </div>
  );
}
...
export function CardFooter({
  ...
  return (
    <div className={`gy-card-footer ${className}`} style={style} {...props}>
      {children}
    </div>
  );
}

...
export const Default: Story = {
  args: { label: 'Message', placeholder: 'Type your message…', helperText: 'Max 500 characters' },
};
...
export const Variants: Story = {
  render: () => (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
      ...
      <Textarea label="Error" variant="error" placeholder="Error" helperText="Something went wrong" />
      <Textarea label="Success" variant="success" placeholder="Success" helperText="Looks good!" hasSuccess />

import{j as r}from"./jsx-runtime-D_zvdyIk.js";import{r as a}from"./index-CC0H-XIk.js";import{T as E}from"./Typography-BPjUOFhO.js";function _(e){return 1-Math.pow(1-e,3)}function z(e){return e<.5?4*e*e*e:1-Math.pow(-2*e+2,3)/2}function c({value:e,variant:n="span",weight:t="regular",duration:p=1e3,format:f,className:R="",prefix:q="",suffix:I="",decimals:j=0,easing:m="easeOut"}){const[g,A]=a.useState(0),d=a.useRef(0),s=a.useRef(null),l=a.useRef(0),h=a.useRef(0);a.useEffect(()=>{d.current=h.current,s.current=null;const S=m==="linear"?i=>i:m==="easeOut"?_:z,v=i=>{s.current||(s.current=i);const C=i-s.current,y=Math.min(C/p,1),D=S(y),k=d.current+(e-d.current)*D;A(k),y<1?l.current=requestAnimationFrame(v):h.current=e};return cancelAnimationFrame(l.current),l.current=requestAnimationFrame(v),()=>cancelAnimationFrame(l.current)},[e,p,m]);const M=f?f(g):g.toFixed(j).replace(/\B(?=(\d{3})+(?!\d))/g,","),$=`${q}${M}${I}`,N={bold:"bold",semibold:"semibold",medium:"medium",regular:"normal",light:"light"},F=n.startsWith("h")?n:n==="p"?"p":"span";return r.jsx(E,{as:F,variant:n==="p"?"p":n==="span"?"span":n,weight:N[t],className:`gy-animated-number ${R}`,children:$})}c.__docgenInfo={description:"",methods:[],displayName:"AnimatedNumber",props:{value:{required:!0,tsType:{name:"number"},description:""},variant:{required:!1,tsType:{name:"union",raw:`| "h1"\r
| "h2"\r
| "h3"\r
| "h4"\r
| "h5"\r

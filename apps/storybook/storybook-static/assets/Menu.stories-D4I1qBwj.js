    ...
    return <Menu variant="bordered" items={menuItems} activeItemId={active} onItemClick={setActive}>\r
        ...
        gap: '0.75rem'
          ...
          <div>\r
            ...
            fontWeight: 600,
            fontSize: '0.875rem'
          }}>Saksham Galyan</div>\r
            <div style={{
            fontSize: '0.75rem',
            color: '#64748b'
          }}>Admin Workspace</div>\r
          </div>\r
        </div>\r
      </Menu>;
  }

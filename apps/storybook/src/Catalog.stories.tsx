...
const CatalogDoc = () => (
  <div style={{ maxWidth: 850, fontFamily: 'system-ui, sans-serif', color: '#0f172a', padding: '1rem' }}>
    ...
    <table style={{ width: '100%', borderCollapse: 'collapse', textAlign: 'left' }}>
      ...
      <tbody>
        <tr style={{ borderBottom: '1px solid #e2e8f0' }}>
          <td style={{ padding: '0.875rem 1rem', fontWeight: 600 }}>Forms & Inputs</td>
          <td style={{ padding: '0.875rem 1rem', color: '#475569' }}>
            Input, Textarea, Checkbox, Radio, Toggle, Dropdown, DatePicker, MonthPicker, FileUpload, InputGroup, DropdownGroup
          </td>
        </tr>
        <tr style={{ borderBottom: '1px solid #e2e8f0' }}>
          <td style={{ padding: '0.875rem 1rem', fontWeight: 600 }}>Navigation</td>
          <td style={{ padding: '0.875rem 1rem', color: '#475569' }}>
            Menu, Breadcrumb, Tabs, StepTab, Stepper
          </td>
        </tr>
        <tr style={{ borderBottom: '1px solid #e2e8f0' }}>
          <td style={{ padding: '0.875rem 1rem', fontWeight: 600 }}>Data Display</td>
          <td style={{ padding: '0.875rem 1rem', color: '#475569' }}>
            Card, Table, Accordion, Banner, Chips, AnimatedNumber, Typography
          </td>
        </tr>
        <tr style={{ borderBottom: '1px solid #e2e8f0' }}>
          <td style={{ padding: '0.875rem 1rem', fontWeight: 600 }}>Feedback & Status</td>
          <td style={{ padding: '0.875rem 1rem', color: '#475569' }}>
